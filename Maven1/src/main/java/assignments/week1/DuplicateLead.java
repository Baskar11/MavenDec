...
public class DuplicateLead {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElementByXPath("//div[@class='x-form-item requiredField']/following::input[@name='firstName'][3]").sendKeys("OliverWilliam");
		...
		driver.findElementById("createLeadForm_firstName").sendKeys(Keys.LEFT_SHIFT, Keys.HOME, Keys.BACK_SPACE, "William");
